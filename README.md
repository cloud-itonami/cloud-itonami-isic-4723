...
- `test/tobaccoretailops/governor_test.clj` — unit tests of governor hard checks, scope exclusion, and a dedicated regression test asserting the default mock-advisor proposals never self-trip scope-exclusion
- `test/tobaccoretailops/advisor_test.clj` — advisor proposal shape and consistency
- `test/tobaccoretailops/phase_test.clj` — rollout phase logic
- `test/tobaccoretailops/governor_contract_test.clj` — full graph integration, audit trail
- `test/tobaccoretailops/store_contract_test.clj` — Store protocol and MemStore implementation
